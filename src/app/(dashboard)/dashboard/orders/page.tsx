...
export default function DashboardOrdersPage() {
  ...
  return (
    <div className="space-y-10">
      <div>
        <h1 className="text-2xl font-extrabold">Store Orders</h1>
        <h4 className="text-neutral-700">See Your Store Transaction History</h4>
      </div>
      ...
      <Tabs defaultValue="all">
        ...
        <TabsContent value="all" className="space-y-5 py-5">
          ...
          {orders?.map((order) => (
            <OrderCard showOrderer key={order.id} order={order} />
          ))}
        </TabsContent>
